...
🌍 Remote / Worldwide  
📧 vitalivo@gmail.com  
💬 Telegram: @vitalivo (fast response)
...
Monitors listing links (category/city/search) and sends new items to Telegram. Rate limited per user (1–10 RPS), built to run 24/7 with queues, dedup, and metrics.  
➜ https://github.com/vitalivo/Parser

🤖 AI-Powered Video Analytics Telegram Bot (LLM-to-SQL)  
Telegram bot that turns natural language questions into SQL analytics on PostgreSQL. Focused on correctness for joins/aggregations/dates and a stable, Docker-first delivery.  
➜ https://github.com/vitalivo/video_analytics_bot

🎯 Mini-CRM — Weighted Lead Distribution Engine  
Lead router with mathematically correct weighted distribution under concurrency limits. Includes a fast demo script and a clean service design.  
➜ https://github.com/vitalivo/mini-crm

🔐 Custom JWT + Full RBAC Auth System  
Auth system from scratch: access/refresh tokens, roles/permissions, admin tooling. Built to get correct 401/403 behavior and predictable permission scopes.  
